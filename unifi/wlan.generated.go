...
func (dst *WLAN) UnmarshalJSON(b []byte) error {
	type Alias WLAN
	aux := &struct {
		DTIM6E                *emptyStringInt   `json:"dtim_6e,omitempty"`
		DTIMNa                *emptyStringInt   `json:"dtim_na,omitempty"`
		DTIMNg                *emptyStringInt   `json:"dtim_ng,omitempty"`
		GroupRekey            *emptyStringInt   `json:"group_rekey,omitempty"`
		MinrateNaDataRateKbps *emptyStringInt   `json:"minrate_na_data_rate_kbps,omitempty"`
		MinrateNgDataRateKbps *emptyStringInt   `json:"minrate_ng_data_rate_kbps,omitempty"`
		RoamClusterID         *emptyStringInt   `json:"roam_cluster_id,omitempty"`
		SaeAntiClogging       *emptyStringInt   `json:"sae_anti_clogging,omitempty"`
		SaeGroups             *[]emptyStringInt `json:"sae_groups,omitempty"`
		SaeSync               *emptyStringInt   `json:"sae_sync,omitempty"`
		VLAN                  *emptyStringInt   `json:"vlan,omitempty"`
		WEPIDX                *emptyStringInt   `json:"wep_idx,omitempty"`
	...
	if aux.SaeGroups != nil {
		tmp := make([]int, len(*aux.SaeGroups))
...
func (dst *WLANScheduleWithDuration) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		DurationMinutes *emptyStringInt `json:"duration_minutes,omitempty"`
		StartHour       *emptyStringInt `json:"start_hour,omitempty"`
		StartMinute     *emptyStringInt `json:"start_minute,omitempty"`
