...
func (dst *Hotspot2Conf) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		AnqpDomainID         *emptyStringInt `json:"anqp_domain_id,omitempty"`
		DeauthReqTimeout     *emptyStringInt `json:"deauth_req_timeout,omitempty"`
		GasComebackDelay     *emptyStringInt `json:"gas_comeback_delay,omitempty"`
		GasFragLimit         *emptyStringInt `json:"gas_frag_limit,omitempty"`
		IPaddrTypeAvailV4    *emptyStringInt `json:"ipaddr_type_avail_v4,omitempty"`
		IPaddrTypeAvailV6    *emptyStringInt `json:"ipaddr_type_avail_v6,omitempty"`
		MetricsDownlinkLoad  *emptyStringInt `json:"metrics_downlink_load,omitempty"`
		MetricsDownlinkSpeed *emptyStringInt `json:"metrics_downlink_speed,omitempty"`
		MetricsMeasurement   *emptyStringInt `json:"metrics_measurement,omitempty"`
		MetricsUplinkLoad    *emptyStringInt `json:"metrics_uplink_load,omitempty"`
		MetricsUplinkSpeed   *emptyStringInt `json:"metrics_uplink_speed,omitempty"`
		NetworkAuthType      *emptyStringInt `json:"network_auth_type,omitempty"`
		NetworkType          *emptyStringInt `json:"network_type,omitempty"`
		TCTimestamp          *emptyStringInt `json:"t_c_timestamp,omitempty"`
		VenueGroup           *emptyStringInt `json:"venue_group,omitempty"`
		VenueType            *emptyStringInt `json:"venue_type,omitempty"`
...
func (dst *Hotspot2ConfCellularNetworkList) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		Mcc *emptyStringInt `json:"mcc,omitempty"`
		Mnc *emptyStringInt `json:"mnc,omitempty"`
...
func (dst *Hotspot2ConfIcons) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		Height *emptyStringInt `json:"height,omitempty"`
		Size   *emptyStringInt `json:"size,omitempty"`
		Width  *emptyStringInt `json:"width,omitempty"`
...
func (dst *Hotspot2ConfNaiRealmList) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		EapMethod *emptyStringInt `json:"eap_method,omitempty"`
		Encoding  *emptyStringInt `json:"encoding,omitempty"`
...
func (dst *Hotspot2ConfQOSMapDcsp) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		High *emptyStringInt `json:"high,omitempty"`
		Low  *emptyStringInt `json:"low,omitempty"`
...
func (dst *Hotspot2ConfQOSMapExceptions) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		Dcsp *emptyStringInt `json:"dcsp,omitempty"`
		Up   *emptyStringInt `json:"up,omitempty"`
