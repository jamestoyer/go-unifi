...
func (dst *SettingUsg) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		ArpCacheBaseReachable *emptyStringInt `json:"arp_cache_base_reachable,omitempty"`
		DHCPRelayHopCount     *emptyStringInt `json:"dhcp_relay_hop_count,omitempty"`
		DHCPRelayMaxSize      *emptyStringInt `json:"dhcp_relay_max_size,omitempty"`
		DHCPRelayPort         *emptyStringInt `json:"dhcp_relay_port,omitempty"`
		ICMPTimeout           *emptyStringInt `json:"icmp_timeout,omitempty"`
		MssClampMss           *emptyStringInt `json:"mss_clamp_mss,omitempty"`
		OtherTimeout          *emptyStringInt `json:"other_timeout,omitempty"`
		TCPCloseTimeout       *emptyStringInt `json:"tcp_close_timeout,omitempty"`
		TCPCloseWaitTimeout   *emptyStringInt `json:"tcp_close_wait_timeout,omitempty"`
		TCPEstablishedTimeout *emptyStringInt `json:"tcp_established_timeout,omitempty"`
		TCPFinWaitTimeout     *emptyStringInt `json:"tcp_fin_wait_timeout,omitempty"`
		TCPLastAckTimeout     *emptyStringInt `json:"tcp_last_ack_timeout,omitempty"`
		TCPSynRecvTimeout     *emptyStringInt `json:"tcp_syn_recv_timeout,omitempty"`
		TCPSynSentTimeout     *emptyStringInt `json:"tcp_syn_sent_timeout,omitempty"`
		TCPTimeWaitTimeout    *emptyStringInt `json:"tcp_time_wait_timeout,omitempty"`
		UDPOtherTimeout       *emptyStringInt `json:"udp_other_timeout,omitempty"`
		UDPStreamTimeout      *emptyStringInt `json:"udp_stream_timeout,omitempty"`
