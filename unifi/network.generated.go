...
func (dst *Network) UnmarshalJSON(b []byte) error {
	type Alias Network
	aux := &struct {
		DHCPDLeaseTime                 *emptyStringInt `json:"dhcpd_leasetime,omitempty"`
		DHCPDTimeOffset                *emptyStringInt `json:"dhcpd_time_offset,omitempty"`
		DHCPDV6LeaseTime               *emptyStringInt `json:"dhcpdv6_leasetime,omitempty"`
		IGMPGroupmembership            *emptyStringInt `json:"igmp_groupmembership,omitempty"`
		IGMPMaxresponse                *emptyStringInt `json:"igmp_maxresponse,omitempty"`
		IGMPMcrtrexpiretime            *emptyStringInt `json:"igmp_mcrtrexpiretime,omitempty"`
		IPSecDhGroup                   *emptyStringInt `json:"ipsec_dh_group,omitempty"`
		IPSecEspDhGroup                *emptyStringInt `json:"ipsec_esp_dh_group,omitempty"`
		IPSecIkeDhGroup                *emptyStringInt `json:"ipsec_ike_dh_group,omitempty"`
		IPV6RaPreferredLifetime        *emptyStringInt `json:"ipv6_ra_preferred_lifetime,omitempty"`
		IPV6RaValidLifetime            *emptyStringInt `json:"ipv6_ra_valid_lifetime,omitempty"`
		InterfaceMtu                   *emptyStringInt `json:"interface_mtu,omitempty"`
		InternetAccessEnabled          *bool           `json:"internet_access_enabled"`
		LocalPort                      *emptyStringInt `json:"local_port,omitempty"`
		OpenVPNLocalPort               *emptyStringInt `json:"openvpn_local_port,omitempty"`
		OpenVPNRemotePort              *emptyStringInt `json:"openvpn_remote_port,omitempty"`
		PptpcRouteDistance             *emptyStringInt `json:"pptpc_route_distance,omitempty"`
		Priority                       *emptyStringInt `json:"priority,omitempty"`
		RouteDistance                  *emptyStringInt `json:"route_distance,omitempty"`
		UidPublicGatewayPort           *emptyStringInt `json:"uid_public_gateway_port,omitempty"`
		UidVPNMaxConnectionTimeSeconds *emptyStringInt `json:"uid_vpn_max_connection_time_seconds,omitempty"`
		VLAN                           *emptyStringInt `json:"vlan,omitempty"`
		VrrpVrid                       *emptyStringInt `json:"vrrp_vrid,omitempty"`
		WANDHCPCos                     *emptyStringInt `json:"wan_dhcp_cos,omitempty"`
		WANDHCPv6PDSize                *emptyStringInt `json:"wan_dhcpv6_pd_size,omitempty"`
		WANEgressQOS                   *emptyStringInt `json:"wan_egress_qos,omitempty"`
		WANLoadBalanceWeight           *emptyStringInt `json:"wan_load_balance_weight,omitempty"`
		WANPrefixlen                   *emptyStringInt `json:"wan_prefixlen,omitempty"`
		WANSmartqDownRate              *emptyStringInt `json:"wan_smartq_down_rate,omitempty"`
		WANSmartqUpRate                *emptyStringInt `json:"wan_smartq_up_rate,omitempty"`
		WANVLAN                        *emptyStringInt `json:"wan_vlan,omitempty"`
		WireguardClientPeerPort        *emptyStringInt `json:"wireguard_client_peer_port,omitempty"`
...
func (dst *NetworkWANDHCPOptions) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		OptionNumber *emptyStringInt `json:"optionNumber,omitempty"`
...
func (dst *NetworkWANProviderCapabilities) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		DownloadKilobitsPerSecond *emptyStringInt `json:"download_kilobits_per_second,omitempty"`
		UploadKilobitsPerSecond   *emptyStringInt `json:"upload_kilobits_per_second,omitempty"`
