...
func (dst *Device) UnmarshalJSON(b []byte) error {
	type Alias Device
	aux := &struct {
		GatewayVrrpPriority        *emptyStringInt   `json:"gateway_vrrp_priority,omitempty"`
		LcmBrightness              *emptyStringInt   `json:"lcm_brightness,omitempty"`
		LcmIDleTimeout             *emptyStringInt   `json:"lcm_idle_timeout,omitempty"`
		LedOverrideColorBrightness *emptyStringInt   `json:"led_override_color_brightness,omitempty"`
		LteExtAnt                  *booleanishString `json:"lte_ext_ant,omitempty"`
		LteHardLimit               *emptyStringInt   `json:"lte_hard_limit,omitempty"`
		LtePoe                     *booleanishString `json:"lte_poe,omitempty"`
		LteSimPin                  *emptyStringInt   `json:"lte_sim_pin,omitempty"`
		LteSoftLimit               *emptyStringInt   `json:"lte_soft_limit,omitempty"`
		PowerSourceCtrlBudget      *emptyStringInt   `json:"power_source_ctrl_budget,omitempty"`
		StpPriority                *numberOrString   `json:"stp_priority,omitempty"`
		Volume                     *emptyStringInt   `json:"volume,omitempty"`
...
func (dst *DeviceEtherLighting) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		Brightness *emptyStringInt `json:"brightness,omitempty"`
...
func (dst *DeviceOutletOverrides) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		Index *emptyStringInt `json:"index,omitempty"`
...
func (dst *DevicePortOverrides) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		AggregateNumPorts          *emptyStringInt `json:"aggregate_num_ports,omitempty"`
		Dot1XIDleTimeout           *emptyStringInt `json:"dot1x_idle_timeout,omitempty"`
		EgressRateLimitKbps        *emptyStringInt `json:"egress_rate_limit_kbps,omitempty"`
		MirrorPortIDX              *emptyStringInt `json:"mirror_port_idx,omitempty"`
		PortIDX                    *emptyStringInt `json:"port_idx,omitempty"`
		PriorityQueue1Level        *emptyStringInt `json:"priority_queue1_level,omitempty"`
		PriorityQueue2Level        *emptyStringInt `json:"priority_queue2_level,omitempty"`
		PriorityQueue3Level        *emptyStringInt `json:"priority_queue3_level,omitempty"`
		PriorityQueue4Level        *emptyStringInt `json:"priority_queue4_level,omitempty"`
		Speed                      *emptyStringInt `json:"speed,omitempty"`
		StormctrlBroadcastastLevel *emptyStringInt `json:"stormctrl_bcast_level,omitempty"`
		StormctrlBroadcastastRate  *emptyStringInt `json:"stormctrl_bcast_rate,omitempty"`
		StormctrlMcastLevel        *emptyStringInt `json:"stormctrl_mcast_level,omitempty"`
		StormctrlMcastRate         *emptyStringInt `json:"stormctrl_mcast_rate,omitempty"`
		StormctrlUcastLevel        *emptyStringInt `json:"stormctrl_ucast_level,omitempty"`
...
func (dst *DeviceQOSMarking) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		CosCode          *emptyStringInt `json:"cos_code,omitempty"`
		DscpCode         *emptyStringInt `json:"dscp_code,omitempty"`
		IPPrecedenceCode *emptyStringInt `json:"ip_precedence_code,omitempty"`
		Queue            *emptyStringInt `json:"queue,omitempty"`
...
func (dst *DeviceQOSMatching) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		CosCode          *emptyStringInt `json:"cos_code,omitempty"`
		DscpCode         *emptyStringInt `json:"dscp_code,omitempty"`
		DstPort          *emptyStringInt `json:"dst_port,omitempty"`
		IPPrecedenceCode *emptyStringInt `json:"ip_precedence_code,omitempty"`
		SrcPort          *emptyStringInt `json:"src_port,omitempty"`
...
func (dst *DeviceRadioTable) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		AntennaGain   *emptyStringInt `json:"antenna_gain,omitempty"`
		AntennaID     *emptyStringInt `json:"antenna_id,omitempty"`
		BackupChannel *numberOrString `json:"backup_channel,omitempty"`
		Channel       *numberOrString `json:"channel,omitempty"`
		Ht            *emptyStringInt `json:"ht,omitempty"`
		Maxsta        *emptyStringInt `json:"maxsta,omitempty"`
		MinRssi       *emptyStringInt `json:"min_rssi,omitempty"`
		SensLevel     *emptyStringInt `json:"sens_level,omitempty"`
		TxPower       *numberOrString `json:"tx_power,omitempty"`
