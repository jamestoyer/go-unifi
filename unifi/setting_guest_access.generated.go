...
func (dst *SettingGuestAccess) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		ExpireNumber               *emptyStringInt `json:"expire_number,omitempty"`
		ExpireUnit                 *emptyStringInt `json:"expire_unit,omitempty"`
		PortalCustomizedBoxOpacity *emptyStringInt `json:"portal_customized_box_opacity,omitempty"`
		PortalCustomizedBoxRADIUS  *emptyStringInt `json:"portal_customized_box_radius,omitempty"`
		PortalCustomizedLogoSize   *emptyStringInt `json:"portal_customized_logo_size,omitempty"`
		RADIUSDisconnectPort       *emptyStringInt `json:"radius_disconnect_port,omitempty"`
