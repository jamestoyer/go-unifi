...
func (dst *SettingSuperMgmt) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		AutobackupDays                           *emptyStringInt `json:"autobackup_days,omitempty"`
		AutobackupMaxFiles                       *emptyStringInt `json:"autobackup_max_files,omitempty"`
		DataRetentionTimeInHoursFor5MinutesScale *emptyStringInt `json:"data_retention_time_in_hours_for_5minutes_scale,omitempty"`
		DataRetentionTimeInHoursForDailyScale    *emptyStringInt `json:"data_retention_time_in_hours_for_daily_scale,omitempty"`
		DataRetentionTimeInHoursForHourlyScale   *emptyStringInt `json:"data_retention_time_in_hours_for_hourly_scale,omitempty"`
		DataRetentionTimeInHoursForMonthlyScale  *emptyStringInt `json:"data_retention_time_in_hours_for_monthly_scale,omitempty"`
		DataRetentionTimeInHoursForOthers        *emptyStringInt `json:"data_retention_time_in_hours_for_others,omitempty"`
		MinimumUsableHdSpace                     *emptyStringInt `json:"minimum_usable_hd_space,omitempty"`
		MinimumUsableSdSpace                     *emptyStringInt `json:"minimum_usable_sd_space,omitempty"`
