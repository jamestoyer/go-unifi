...
func (dst *HotspotPackage) UnmarshalJSON(b []byte) error {
	...
	aux := &struct {
		Hours                *emptyStringInt `json:"hours,omitempty"`
		Index                *emptyStringInt `json:"index,omitempty"`
		LimitDown            *emptyStringInt `json:"limit_down,omitempty"`
		LimitQuota           *emptyStringInt `json:"limit_quota,omitempty"`
		LimitUp              *emptyStringInt `json:"limit_up,omitempty"`
		TrialDurationMinutes *emptyStringInt `json:"trial_duration_minutes,omitempty"`
